    ...
    >
      ...
      <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                ...
                <input list='cityList' id="cityInput" type="text" className="rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none" placeholder="Type here" required
                />
                ...
                <input list='countryList' id="countryInput" type="text" className="rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none" placeholder="Type here" required
                />
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-black py-2 px-3 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
