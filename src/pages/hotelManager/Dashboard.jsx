...
import { dashboardDummyData } from '../../dashboardDummyData';
            ...
            <tbody className='text-sm'>
                {dashboardData.bookings.map((item, index) => (
                    <tr key={index}>
                        ...
                        {/* Remove flex, use text-center */}
                        <td className='py-3 px-4 border-t border-gray-300 text-center'>
                            <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? 'bg-green-200 text-green-800' : 'bg-amber-200 text-yellow-600'}`}>
